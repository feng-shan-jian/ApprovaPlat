...
-- 初始化-用户信息表数据
-- ----------------------------
-- admin 默认停用且没有可用口令；首次启动必须通过受控一次性初始化流程写入随机密码后启用。
insert into sys_user values(1, 100, 'admin', '管理员', '00', '', '', '2', '', '!RUOYI_BOOTSTRAP_REQUIRED!', '1', '0', '', null, null, 'bootstrap', sysdate(), '', null, '系统管理员');
