...
VALUES
    ...
    ('workflow:notification:mailManage', 'workflow:notification:policyList', '邮件服务管理', 4, '', NULL, '',
     'F', 'workflow:notification:mailManage', '#', '查询、维护并测试平台 SMTP 邮件服务配置'),
    ('workflow:notification:urge:any', 'workflow:notification:policyList', '跨实例催办', 5, '', NULL, '',
